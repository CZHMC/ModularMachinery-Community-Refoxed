...
public final class OversizeOutputInterfaceKind implements InterfaceLogicKind {
    public static final OversizeOutputInterfaceKind INSTANCE = new OversizeOutputInterfaceKind();
    ...
    private OversizeOutputInterfaceKind() {}
